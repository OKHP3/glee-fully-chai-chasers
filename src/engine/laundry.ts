...
/**
 * 2026-07-15 release contract: 300/400/500. Cut to 40/60/80 in a same-month
 * RTP retune, then restored here (S33) once retriggers were blocked
 * engine-wide — the runaway-session risk that motivated the cut no longer
 * exists, so the original award stands and PAYOUT_SCALE absorbs the RTP.
 */
