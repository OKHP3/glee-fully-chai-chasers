    ...
    <div class="relative h-full w-full flex flex-col text-amber-100 overflow-hidden cc-root" data-theme="${resolvedTheme}" data-reduced-motion="${state.reducedMotion}">
      ...
      <div class="relative z-10 h-full w-full flex flex-col cc-shell">
        ...
        <div class="cabinet-shell">
          <div id="bonus-banner" class="bonus-banner" aria-live="polite">
...
function treatTimeHandSvg(): string {
  // Cartoon open palm — 4 separated fingers + filled thumb + gradient depth + cuff.
  // Gradient IDs are document-scoped but both call sites produce identical SVGs so
  // sharing the same ID causes no visual difference.
  return `<svg viewBox="0 0 88 110" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="tth-fill" x1="0.3" y1="0" x2="0.75" y2="1">
        <stop offset="0%" stop-color="#fde9a8"/>
        <stop offset="100%" stop-color="#e8ab36"/>
      </linearGradient>
      <linearGradient id="tth-cuff" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0%" stop-color="#9461f0"/>
        <stop offset="100%" stop-color="#5b18c4"/>
      </linearGradient>
    </defs>

    <!-- Sleeve / cuff -->
    <rect x="18" y="93" width="52" height="17" rx="5"
      fill="url(#tth-cuff)" stroke="#2d1f4c" stroke-width="2.5"/>
    <rect x="18" y="93" width="52" height="6" rx="3"
      fill="rgba(255,248,238,.14)"/>
    <path d="M21 100 Q44 104 67 100"
      fill="none" stroke="#f2c84b" stroke-width="1.5"
      stroke-linecap="round" opacity=".7"/>

    <!-- Thumb (filled, behind main hand so junction is hidden) -->
    <path d="M22 83 C13 80 6 71 8 61 C10 53 18 51 24 57 L24 75 Z"
      fill="url(#tth-fill)" stroke="#2d1f4c" stroke-width="3"
      stroke-linejoin="round"/>

    <!-- 4-finger + palm silhouette.
         Fingers (left→right): index (22–33, tip y=32), middle (33–45, tip y=16),
         ring (45–57, tip y=22), pinky (57–67, tip y=36).
         Path traces outer boundary: up left of index, around each fingertip,
         down valleys between fingers, down right of pinky, curve around palm. -->
    <path d="
      M22 90
      L22 36 C22 28 33 28 33 36
      L33 58
      L33 20 C33 12 45 12 45 20
      L45 58
      L45 26 C45 18 57 18 57 26
      L57 60
      L57 40 C57 32 67 32 67 40
      L67 76 C70 88 70 90 66 90
      Z"
      fill="url(#tth-fill)" stroke="#2d1f4c" stroke-width="3.5"
      stroke-linejoin="round"/>

    <!-- Finger valley lines (crease depth between fingers) -->
    <line x1="33" y1="52" x2="33" y2="58"
      stroke="#2d1f4c" stroke-width="1.5" stroke-linecap="round" opacity=".5"/>
    <line x1="45" y1="52" x2="45" y2="58"
      stroke="#2d1f4c" stroke-width="1.5" stroke-linecap="round" opacity=".5"/>
    <line x1="57" y1="54" x2="57" y2="60"
      stroke="#2d1f4c" stroke-width="1.5" stroke-linecap="round" opacity=".5"/>

    <!-- Knuckle highlights (one per finger, at the base-of-finger crease) -->
    <ellipse cx="27" cy="59" rx="3" ry="2" fill="rgba(255,248,238,.44)"/>
    <ellipse cx="39" cy="57" rx="3" ry="2" fill="rgba(255,248,238,.44)"/>
    <ellipse cx="51" cy="57" rx="3" ry="2" fill="rgba(255,248,238,.44)"/>
    <ellipse cx="62" cy="61" rx="2.5" ry="2" fill="rgba(255,248,238,.44)"/>

    <!-- Palm highlight streak -->
    <path d="M28 78 Q44 74 62 78"
      fill="none" stroke="rgba(255,248,238,.28)"
