...
export function Scene7() {
  ...
  return (
    ...
    >
      ...
      {/* Ambient glow orb — paused when motion is reduced */}
      <motion.div
        ...
        animate={rm ? {} : { scale: [1, 1.2, 1], rotate: [0, 90, 0] }}
        transition={rm ? { duration: 0 } : { duration: 10, repeat: Infinity, ease: 'easeInOut' }}
      />
      ...
      <motion.div
        ...
        transition={reducedTransition(rm, { delay: 0.5, duration: 1, type: 'spring' })}
      />
      <motion.div
        ...
        initial={{ opacity: 0, y: -50, rotate: 20 }}
        animate={{ opacity: 1, y: 0, rotate: 10 }}
        transition={reducedTransition(rm, { delay: 0.7, duration: 1, type: 'spring' })}
      />
      ...
      <div className="relative z-20 text-center flex flex-col items-center">
        <motion.h2
          ...
          transition={reducedTransition(rm, { duration: 0.8, delay: 1 })}
        >
          Join the chase
        </motion.h2>
        ...
        <motion.h1
          ...
          transition={reducedTransition(rm, { duration: 0.8, delay: 1.3, type: 'spring' })}
        >
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={reducedTransition(rm, { type: 'spring', stiffness: 300, damping: 20, delay: 2 })}
        >
