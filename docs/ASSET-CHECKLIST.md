...
| GitHub + web social preview — refined Joey, Phoebe, jewel-toned iced chai, rainbow butterfly, and keepsakes | ChatGPT imagegen, 2026-08-10; refined using the repository's original game art as references | original | ☑ `public/assets/social-preview.jpg` |
...
| Asset | Spec | Owner | Provenance | Status |
|---|---|---|---|---|
| Chai Chasers showcase video | 45-second 16:9 animated build-in-public promo; 7 scenes; React + Framer Motion source maintained in this repository | Replit Agent + Jamie Hill, v3 exported 2026-08-11 | original; all source images original (see rows above); background music original (lo-fi folk, generated) | ☑ `artifacts/chai-chasers-video/public/chai-chasers-v3-showcase.mp4` |
