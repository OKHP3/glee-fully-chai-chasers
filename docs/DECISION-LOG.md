...
| S24 | 2026-07-12 | **Stranger Danger Panic bonus.** An original house-doorbell blocker may appear on reels 1–2; a pair on the first two positions of any payline triggers a direct 5–20-spin bonus where Joey and Phoebe land as randomly placed wilds on payline coordinates each round. No real-product name, logo, or trade dress is used | Jamie's requested Joey/Phoebe stranger-at-the-door gag; mechanic is documented in `docs/DOORBELL-PANIC-2026-07-12.md` |
